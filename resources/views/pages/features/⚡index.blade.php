...
<section class="w-full">
    <div>
        <flux:heading level="1" size="xl">{{ __('Features Activation') }}</flux:heading>
        <flux:subheading>{{ __('Aktifkan atau nonaktifkan fitur konten yang tampil di situs publik dan panel admin.') }}</flux:subheading>
    </div>
