...
// Theme toggle for this page (persist using same key as AppLayout: `dark-mode`)
...
function applyDark(value) {
    ...
    // use 'dark-mode' key to match AppLayout.vue
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    ...
                    <nav v-if="canLogin" class="-mx-3 flex flex-1 justify-end items-center gap-2">
                        <!-- Theme toggle button (styled like AppLayout) -->
                        <div v-if="$page.props.auth.user" class="me-3">
