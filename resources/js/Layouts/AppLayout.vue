...
// Sidebar collapsed state — synced via custom window event from Sidebar.vue
...
onMounted(() => {
    ...
    try {
        ...
        if (storedCollapse !== null) sidebarCollapsed.value = storedCollapse === '1';
    } catch (e) { }
...
const handleSidebarCollapse = (e) => {
    sidebarCollapsed.value = e.detail;
};
...
<template>
    <div>
        ...
        <div
            :class="['flex flex-col min-h-screen bg-gray-100 dark:bg-gray-900 transition-all duration-300', sidebarCollapsed ? 'lg:pl-16' : 'lg:pl-64']">
            <div class="flex-1">
                <!-- Page Heading -->
