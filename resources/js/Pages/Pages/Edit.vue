<template>
  ...
  <AppLayout :title="`Edit ${page.title}`">
    <template #header>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <form @submit.prevent="submit" class="space-y-6">
        ...
        <div>
          ...
          <!-- Current Hero Image -->
          <div v-if="page.hero_image && !heroImagePreview" class="mt-2 mb-3">
            ...
            <div class="w-full relative">
              <div class="w-full pb-[56.25%] relative bg-gray-200 dark:bg-gray-700 rounded-lg overflow-hidden">
                <img :src="page.hero_image" alt="Current hero" class="absolute inset-0 w-full h-full object-cover" />
              </div>
            </div>
          </div>
          ...
          <div v-if="heroImagePreview" class="mt-4">
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">New preview:</p>
            <div class="w-full relative">
              <div class="w-full pb-[56.25%] relative bg-gray-200 dark:bg-gray-700 rounded-lg overflow-hidden">
        ...
        <div v-if="form.has_cta_section" class="space-y-4 p-4 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800">
          ...
          <div>
            ...
            <div v-if="page.cta_bg_image && !ctaBgImagePreview" class="mt-2 mb-3">
              <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Current background:</p>
              <img :src="page.cta_bg_image" alt="Current CTA background" class="w-full h-48 object-cover rounded-lg" />
            </div>
            ...
            <!-- New CTA Background Preview -->
            <div v-if="ctaBgImagePreview" class="mt-2">
              <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">New background:</p>
...
const form = useForm({
  ...
  has_cta_section: props.page.has_cta_section,
  cta_bg_image: null,
  cta_title: props.page.cta_title || '',
  cta_description: props.page.cta_description || '',
  cta_button_text: props.page.cta_button_text || '',
  cta_button_url: props.page.cta_button_url || '',
  status: props.page.status,
  show_in_menu: props.page.show_in_menu || false,
  menu_order: props.page.menu_order || 0,
...
const submit = () => {
  form.post(route('pages.update', props.page.slug), {
    forceFormData: true,
    preserveScroll: true,
  });
};
