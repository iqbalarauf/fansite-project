...
class ShowTeaterCategorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $categories = [
            ...
            ['id' => 2, 'type' => 'setlist', 'setlist_id' => null, 'name' => 'BANZAI JKT48', 'jp_name' => '', 'created_at' => $now],
            ...
            ['id' => 7, 'type' => 'setlist', 'setlist_id' => null, 'name' => 'Pajama Drive', 'jp_name' => '', 'created_at' => $now],
            ...
            ['id' => 11, 'type' => 'setlist', 'setlist_id' => null, 'name' => 'KIRA-KIRA Girls', 'jp_name' => '', 'created_at' => $now],
            ...
            ['id' => 17, 'type' => 'setlist', 'setlist_id' => null, 'name' => 'Saka Agari', 'jp_name' => '', 'created_at' => $now],
            ...
            ['id' => 32, 'type' => 'unit_song', 'setlist_id' => 2, 'name' => 'Ajak Aku Pergi Menuju ke Wimbledon', 'jp_name' => 'Wimbledon e Tsureteitte', 'created_at' => $now],
