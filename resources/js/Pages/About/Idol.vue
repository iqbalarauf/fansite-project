                        ...
                        <div class="p-6 sm:p-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center">
                                ...
                                <div v-if="instagramUsername" class="flex flex-col items-center w-full max-w-[400px]">
                                    <h5 class="text-lg font-semibold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                                    ...
                                    <div class="w-full h-[480px] flex flex-col">
                                        ...
                                        <a :href="settings.idol_social_media_instagram"
                                           ...
                                           class="mt-3 text-sm text-indigo-600 dark:text-indigo-400 hover:underline text-center">
                                            View on Instagram →
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div v-if="tiktokUsername" class="flex flex-col items-center w-full max-w-[325px]">
                                    ...
                                    <div class="w-full h-[480px] overflow-hidden">
                                        <blockquote
                                ...
                                <div v-if="twitterUsername" class="flex flex-col items-center w-full max-w-[325px]">
                                    ...
                                    <div class="w-full h-[480px] bg-white dark:bg-gray-900 rounded-lg shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700 flex flex-col">
                                        <!-- Profile Header -->
